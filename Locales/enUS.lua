POINT_BLANK_SNIPER_LOCALES.enUS = function()
  ...
  L["NO_GEAR_MODE"] = "No gear mode (faster than with gear)"
  ...
  L["ITEM_INFO_DB_CREATING"] = "Creating item information database."
  ...
  L["ITEM_INFO_DB_CREATED"] = "Item information database successfully created."
