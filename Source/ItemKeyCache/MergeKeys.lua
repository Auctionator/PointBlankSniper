function PointBlankSniper.ItemKeyCache.MergeKeys()
  if #PointBlankSniper.ItemKeyCache.State.newKeys.names == 0 then
    return
  end
  ...
  PointBlankSniper.Utilities.Message(POINT_BLANK_SNIPER_L_ITEMS_SYNCED:format(#PointBlankSniper.ItemKeyCache.State.orderedKeys.names))
end
